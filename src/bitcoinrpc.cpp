...
// bitcoin: get network Gh/s estimate
...
Value walletpassphrase(const Array& params, bool fHelp)
{
    ...
    // bitcoin: if user OS account compromised prevent trivial sendmoney commands
    if (params.size() > 2)
...
// bitcoin: get information of sync-checkpoint
...
// bitcoin: reserve balance from being staked for network protection
...
// bitcoin: check wallet integrity
...
// bitcoin: make a public-private key pair
